<cfcomponent output="false">	
	...
	<cfset this.name = "ColdFusion10_QRToad">
	...
	<!--- CF10 - Add Custom Java lib paths to load jars on the fly --->
	<cfset this.javaSettings = {LoadPaths = ["..\libs\"], loadColdFusionClassPath = true, reloadOnChange = false}>
